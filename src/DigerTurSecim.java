...
public class DigerTurSecim {
    ...
    public DigerTurSecim(String kullaniciEmail) {
        ...
        frame = ModernTheme.createModernFrame("Diğer Turlar");
        ...
        // Başlık
        JLabel title = ModernTheme.createTitleLabel("🗺️ Diğer Turlar");
        JLabel subtitle = ModernTheme.createSubtitleLabel("Çok günlük turlarımız");
